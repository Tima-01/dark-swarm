...
public class SummonerDiamondChestplateArmorRenderer implements ArmorRenderer {
    ...
    public void render(MatrixStack matrices,
        ...
        if (!stack.isOf(ModItems.SUMMONER_DIAMOND_CHESTPLATE)) return;
        ...
        // fire overlay
        if (ArmorUtil.hasEnhancement(stack, ArmorEnhancement.FIRE.getId())) {
        ...
        // ice overlay
        if (ArmorUtil.hasEnhancement(stack, ArmorEnhancement.ICE.getId())) {
