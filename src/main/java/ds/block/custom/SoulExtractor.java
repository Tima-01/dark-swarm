...
public class SoulExtractor extends BlockWithEntity implements BlockEntityProvider {
    ...
    public static final MapCodec<SoulExtractor> CODEC = SoulExtractor.createCodec(SoulExtractor::new);

    public SoulExtractor(Settings settings) {
        super(settings);
    }
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new SoulExtractorEntity(pos, state);
    }
